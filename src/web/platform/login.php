...
$message_jwt = [
    "iss" => 'https://lti-tool.elephango.com',
    ...
    "https://purl.imsglobal.org/spec/lti-nrps/claim/namesroleservice" => [
        "context_memberships_url" => "https://lti-tool.elephango.com/platform/services/nrps",
    ...
    "https://purl.imsglobal.org/spec/lti-ags/claim/endpoint" => [
        ...
        "lineitems" => "https://lti-tool.elephango.com/platform/services/ags/lineitems.php",
    ],
    "https://purl.imsglobal.org/spec/lti-gs/claim/groupsservice" => [
        "scope" => [
          "https://purl.imsglobal.org/spec/lti-gs/scope/contextgroup.readonly"
        ],
        "context_groups_url" => "https://lti-tool.elephango.com/platform/services/gs/groups",
        "context_group_sets_url" => "https://lti-tool.elephango.com/platform/services/gs/sets",
